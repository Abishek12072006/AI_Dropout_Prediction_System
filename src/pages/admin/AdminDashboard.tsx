...
const AdminDashboard = () => {
  ...
  const pieData = [
    { name: "Low Risk", value: low, color: "hsl(152, 60%, 42%)" },
  ...
  return (
    <div className="space-y-6 max-w-7xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Overview of student dropout risk analytics</p>
      </div>
        ...
        <div className="rounded-xl border bg-card p-5 shadow-sm animate-fade-in">
          ...
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={deptData}>
              ...
              <Tooltip />
              <Bar dataKey="low" stackId="a" fill="hsl(152, 60%, 42%)" radius={[0, 0, 0, 0]} name="Low" />
